...
class ChatRoom extends colyseus_1.Room {
    ...
    onCreate(options) {
        ...
        this.setState(new chat_schema_1.ChatRoomState());
        ...
        // Редактирование
        this.onMessage("edit_message", (client, data) => {
            this.handleEditMessage(client, data);
        });
        // Удаление
        this.onMessage("delete_message", (client, data) => {
            this.handleDeleteMessage(client, data);
        });
        // Реакция
        this.onMessage("add_reaction", (client, data) => {
    ...
    onJoin(client, options) {
        ...
        if (existingUser) {
            ...
            // Создаём нового
            const user = new chat_schema_1.ChatUser();
            user.id = userId;
    ...
    handleSendMessage(client, data) {
        ...
        const message = new chat_schema_1.ChatMessage();
