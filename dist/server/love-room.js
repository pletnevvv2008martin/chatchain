...
exports.LoveRoom = void 0;
const colyseus_1 = require("colyseus");
const love_schema_1 = require("./love-schema");
// ============================================
// LOVE ROOM - Комната игры Любовь
// ============================================
class LoveRoom extends colyseus_1.Room {
    constructor() {
        super(...arguments);
        this.maxClients = 12;
    ...
    onCreate(options) {
        ...
        this.setState(new love_schema_1.LoveRoomState());
        // Настройки комнаты
    ...
    onJoin(client, options) {
        ...
        const player = new love_schema_1.LovePlayer();
    ...
    // ЧАТ
    // ============================================
    handleChatMessage(client, text) {
        const player = this.state.players.get(client.sessionId);
        if (!player || !text.trim())
            return;
        player.lastActive = Date.now();
        const message = new love_schema_1.LoveMessage();
    ...
    startRound() {
        ...
        const config = love_schema_1.ROUND_CONFIG[randomType];
        this.state.roundType = randomType;
    ...
    calculateResults() {
        const result = new love_schema_1.RoundResult();
    ...
    // ГОЛОСОВАНИЕ
    // ============================================
    handleVote(client, targetId, action) {
        ...
        const vote = new love_schema_1.LoveVote();
    ...
    // ПОДАРКИ
    // ============================================
    handleGift(client, targetId, giftId) {
...
exports.LoveRoom = LoveRoom;
//# sourceMappingURL=love-room.js.map