...
export class CastleTerritory extends Schema {
  ...
  @type(["string"]) ownedNodes: string[] = new ArraySchema<string>();
...
export class MapNode extends Schema {
  ...
  @type(["string"]) connections: string[] = new ArraySchema<string>();
...
export class FortressState extends Schema {
  ...
  @type(["string"]) chat: string[] = new ArraySchema<string>();
