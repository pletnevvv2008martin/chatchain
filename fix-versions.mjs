...
const commands = [
  // Удаляем текущие пакеты
  'cd /root/chatchain && npm uninstall colyseus @colyseus/schema',

  // Устанавливаем совместимые версии
  'cd /root/chatchain && npm install colyseus@0.15.0 @colyseus/schema@2.0.8 --legacy-peer-deps',
